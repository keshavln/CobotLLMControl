...
bool addverb_cobot_msgs__msg__cartesian_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool addverb_cobot_msgs__msg__cartesian_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("addverb_cobot_msgs.msg._cartesian_trajectory_point.CartesianTrajectoryPoint", full_classname_dest, 75) == 0);
  }
  addverb_cobot_msgs__msg__CartesianTrajectoryPoint * ros_message = _ros_message;
  {  // point
    PyObject * field = PyObject_GetAttrString(_pymsg, "point");
    if (!field) {
      return false;
    }
    if (!addverb_cobot_msgs__msg__cartesian_point__convert_from_py(field, &ros_message->point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * addverb_cobot_msgs__msg__cartesian_trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("addverb_cobot_msgs.msg._cartesian_trajectory_point");
  ...
  {  // point
    PyObject * field = NULL;
    field = addverb_cobot_msgs__msg__cartesian_point__convert_to_py(&ros_message->point);
    if (!field) {
      return NULL;
    }
    {
