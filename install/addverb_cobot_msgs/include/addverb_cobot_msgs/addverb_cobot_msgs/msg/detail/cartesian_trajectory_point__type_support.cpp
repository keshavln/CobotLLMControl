...
{
  new (message_memory) addverb_cobot_msgs::msg::CartesianTrajectoryPoint(_init);
}

void CartesianTrajectoryPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<addverb_cobot_msgs::msg::CartesianTrajectoryPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CartesianTrajectoryPoint_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<addverb_cobot_msgs::msg::CartesianPoint>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(addverb_cobot_msgs::msg::CartesianTrajectoryPoint, point),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(addverb_cobot_msgs::msg::CartesianTrajectoryPoint, time_from_start),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CartesianTrajectoryPoint_message_members = {
  ...
  2,  // number of fields
  sizeof(addverb_cobot_msgs::msg::CartesianTrajectoryPoint),
...
{
  return &::addverb_cobot_msgs::msg::rosidl_typesupport_introspection_cpp::CartesianTrajectoryPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, addverb_cobot_msgs, msg, CartesianTrajectoryPoint)() {
  return &::addverb_cobot_msgs::msg::rosidl_typesupport_introspection_cpp::CartesianTrajectoryPoint_message_type_support_handle;
}
