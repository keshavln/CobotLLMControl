...
class_map = {v.lower(): k for k, v in model.names.items()}
target_id = class_map['cell phone']
...
class ServoPublisher(Node):
    def __init__(self):
        ...
        self.target_class = extract_object_intent("detect a drone", system_prompt)
    ...
    def image_callback(self, msg):
        ...
        """ results = model(frame, classes=[target_id], verbose=False)
        ...
        if len(boxes) > 0:
            ...
            label = f"{model.names[target_id]} {conf:.2f}"
