...
#define NODE_MAIN_LOGGER_NAME "demo_ptp_joint"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libptp_demo_client.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ptp::DemoClient>";
