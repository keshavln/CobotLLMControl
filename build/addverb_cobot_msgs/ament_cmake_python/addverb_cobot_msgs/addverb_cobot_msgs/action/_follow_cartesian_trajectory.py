    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory_Goal')
            logger.debug(
            ...
            from addverb_cobot_msgs.msg import CartesianTrajectory
...
class FollowCartesianTrajectory_Goal(metaclass=Metaclass_FollowCartesianTrajectory_Goal):
    ...
    _fields_and_field_types = {
        'trajectory': 'addverb_cobot_msgs/CartesianTrajectory',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['addverb_cobot_msgs', 'msg'], 'CartesianTrajectory'),  # noqa: E501
    )
...
class Metaclass_FollowCartesianTrajectory_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_FollowCartesianTrajectory_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowCartesianTrajectory_SendGoal_Request(metaclass=Metaclass_FollowCartesianTrajectory_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'addverb_cobot_msgs/FollowCartesianTrajectory_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['addverb_cobot_msgs', 'action'], 'FollowCartesianTrajectory_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Goal
...
class Metaclass_FollowCartesianTrajectory_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from addverb_cobot_msgs.action import _follow_cartesian_trajectory
...
class FollowCartesianTrajectory_SendGoal(metaclass=Metaclass_FollowCartesianTrajectory_SendGoal):
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal_Request as Request
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal_Response as Response
...
class FollowCartesianTrajectory_GetResult_Response(metaclass=Metaclass_FollowCartesianTrajectory_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'addverb_cobot_msgs/FollowCartesianTrajectory_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['addverb_cobot_msgs', 'action'], 'FollowCartesianTrajectory_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Result
...
class Metaclass_FollowCartesianTrajectory_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowCartesianTrajectory_GetResult(metaclass=Metaclass_FollowCartesianTrajectory_GetResult):
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult_Request as Request
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult_Response as Response
...
class Metaclass_FollowCartesianTrajectory_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowCartesianTrajectory_FeedbackMessage(metaclass=Metaclass_FollowCartesianTrajectory_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'addverb_cobot_msgs/FollowCartesianTrajectory_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['addverb_cobot_msgs', 'action'], 'FollowCartesianTrajectory_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Feedback
...
class Metaclass_FollowCartesianTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.action.FollowCartesianTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowCartesianTrajectory(metaclass=Metaclass_FollowCartesianTrajectory):
    ...
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Goal as Goal
    # The result message defined in the action definition.
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Result as Result
    # The feedback message defined in the action definition.
    from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from addverb_cobot_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_FeedbackMessage as FeedbackMessage
