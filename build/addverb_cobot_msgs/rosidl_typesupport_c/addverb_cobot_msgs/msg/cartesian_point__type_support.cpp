...
static const _CartesianPoint_type_support_symbol_names_t _CartesianPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, msg, CartesianPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addverb_cobot_msgs, msg, CartesianPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, addverb_cobot_msgs, msg, CartesianPoint)() {
  return &::addverb_cobot_msgs::msg::rosidl_typesupport_c::CartesianPoint_message_type_support_handle;
}
