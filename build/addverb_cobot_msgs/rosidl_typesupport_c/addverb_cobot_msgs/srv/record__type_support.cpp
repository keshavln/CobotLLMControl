...
static const _Record_Request_type_support_symbol_names_t _Record_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, srv, Record_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addverb_cobot_msgs, srv, Record_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, addverb_cobot_msgs, srv, Record_Request)() {
  return &::addverb_cobot_msgs::srv::rosidl_typesupport_c::Record_Request_message_type_support_handle;
}
...
static const _Record_Response_type_support_symbol_names_t _Record_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, srv, Record_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addverb_cobot_msgs, srv, Record_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, addverb_cobot_msgs, srv, Record_Response)() {
  return &::addverb_cobot_msgs::srv::rosidl_typesupport_c::Record_Response_message_type_support_handle;
}
...
static const _Record_type_support_symbol_names_t _Record_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, srv, Record)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, addverb_cobot_msgs, srv, Record)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, addverb_cobot_msgs, srv, Record)() {
  return &::addverb_cobot_msgs::srv::rosidl_typesupport_c::Record_service_type_support_handle;
}
