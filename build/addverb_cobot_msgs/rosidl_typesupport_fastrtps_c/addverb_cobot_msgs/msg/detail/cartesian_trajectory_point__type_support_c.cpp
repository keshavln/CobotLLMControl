...
#include "addverb_cobot_msgs/msg/detail/cartesian_trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
#include "addverb_cobot_msgs/msg/detail/cartesian_point__functions.h"  // point

// forward declare type support functions
size_t get_serialized_size_addverb_cobot_msgs__msg__CartesianPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_addverb_cobot_msgs__msg__CartesianPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, msg, CartesianPoint)();


using _CartesianTrajectoryPoint__ros_msg_type = addverb_cobot_msgs__msg__CartesianTrajectoryPoint;
  ...
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, msg, CartesianPoint
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_addverb_cobot_msgs__msg__CartesianPoint(
...
static uint32_t _CartesianTrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  // member: point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_addverb_cobot_msgs__msg__CartesianPoint(
  ...
  if (is_plain) {
    ...
    using DataType = addverb_cobot_msgs__msg__CartesianTrajectoryPoint;
    is_plain =
      (
...
static size_t _CartesianTrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectoryPoint(
