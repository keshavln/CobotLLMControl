...
#include "addverb_cobot_msgs/msg/detail/cartesian_point__rosidl_typesupport_fastrtps_c.h"
...
using _CartesianPoint__ros_msg_type = addverb_cobot_msgs__msg__CartesianPoint;
...
static uint32_t _CartesianPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_addverb_cobot_msgs__msg__CartesianPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = addverb_cobot_msgs__msg__CartesianPoint;
    is_plain =
      (
...
static size_t _CartesianPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_addverb_cobot_msgs__msg__CartesianPoint(
