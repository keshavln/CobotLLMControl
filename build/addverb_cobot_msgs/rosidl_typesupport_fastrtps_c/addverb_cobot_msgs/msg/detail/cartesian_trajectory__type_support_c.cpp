...
#include "addverb_cobot_msgs/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "addverb_cobot_msgs/msg/detail/cartesian_trajectory_point__functions.h"  // points

// forward declare type support functions
size_t get_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectoryPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectoryPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, msg, CartesianTrajectoryPoint)();


using _CartesianTrajectory__ros_msg_type = addverb_cobot_msgs__msg__CartesianTrajectory;
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, addverb_cobot_msgs, msg, CartesianTrajectoryPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      addverb_cobot_msgs__msg__CartesianTrajectoryPoint__Sequence__fini(&ros_message->points);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectoryPoint(
...
static uint32_t _CartesianTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectory(
  ...
  size_t current_alignment)
{
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectoryPoint(
  ...
  if (is_plain) {
    ...
    using DataType = addverb_cobot_msgs__msg__CartesianTrajectory;
    is_plain =
      (
...
static size_t _CartesianTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_addverb_cobot_msgs__msg__CartesianTrajectory(
