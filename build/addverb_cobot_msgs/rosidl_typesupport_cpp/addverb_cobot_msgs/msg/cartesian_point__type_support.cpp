...
static const _CartesianPoint_type_support_symbol_names_t _CartesianPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addverb_cobot_msgs, msg, CartesianPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, addverb_cobot_msgs, msg, CartesianPoint)),
  }
};
...
{
  return &::addverb_cobot_msgs::msg::rosidl_typesupport_cpp::CartesianPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, addverb_cobot_msgs, msg, CartesianPoint)() {
  return get_message_type_support_handle<addverb_cobot_msgs::msg::CartesianPoint>();
}
