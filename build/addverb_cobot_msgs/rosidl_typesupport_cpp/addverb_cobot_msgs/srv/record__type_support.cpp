...
static const _Record_Request_type_support_symbol_names_t _Record_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addverb_cobot_msgs, srv, Record_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, addverb_cobot_msgs, srv, Record_Request)),
  }
};
...
{
  return &::addverb_cobot_msgs::srv::rosidl_typesupport_cpp::Record_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, addverb_cobot_msgs, srv, Record_Request)() {
  return get_message_type_support_handle<addverb_cobot_msgs::srv::Record_Request>();
}
...
static const _Record_Response_type_support_symbol_names_t _Record_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addverb_cobot_msgs, srv, Record_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, addverb_cobot_msgs, srv, Record_Response)),
  }
};
...
{
  return &::addverb_cobot_msgs::srv::rosidl_typesupport_cpp::Record_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, addverb_cobot_msgs, srv, Record_Response)() {
  return get_message_type_support_handle<addverb_cobot_msgs::srv::Record_Response>();
}
...
static const _Record_type_support_symbol_names_t _Record_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addverb_cobot_msgs, srv, Record)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, addverb_cobot_msgs, srv, Record)),
  }
};
...
{
  return &::addverb_cobot_msgs::srv::rosidl_typesupport_cpp::Record_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, addverb_cobot_msgs, srv, Record)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<addverb_cobot_msgs::srv::Record>();
}
