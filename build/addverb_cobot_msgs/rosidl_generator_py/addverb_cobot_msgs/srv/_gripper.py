...
class Gripper_Request(metaclass=Metaclass_Gripper_Request):
    ...
    def grasp_force(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'grasp_force' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
...
class Metaclass_Gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'addverb_cobot_msgs.srv.Gripper')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from addverb_cobot_msgs.srv import _gripper
...
class Gripper(metaclass=Metaclass_Gripper):
    from addverb_cobot_msgs.srv._gripper import Gripper_Request as Request
    from addverb_cobot_msgs.srv._gripper import Gripper_Response as Response
