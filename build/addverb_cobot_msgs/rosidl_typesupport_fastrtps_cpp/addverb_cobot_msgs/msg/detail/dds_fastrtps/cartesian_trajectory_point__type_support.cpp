...
#include "addverb_cobot_msgs/msg/detail/cartesian_trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const addverb_cobot_msgs::msg::CartesianPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  addverb_cobot_msgs::msg::CartesianPoint &);
...
cdr_serialize(
  const addverb_cobot_msgs::msg::CartesianTrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  addverb_cobot_msgs::msg::CartesianTrajectoryPoint & ros_message)
{
  // Member: point
  ...
  size_t current_alignment)
{
  ...
  // Member: point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        addverb_cobot_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CartesianPoint(
  ...
  if (is_plain) {
    ...
    using DataType = addverb_cobot_msgs::msg::CartesianTrajectoryPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const addverb_cobot_msgs::msg::CartesianTrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<addverb_cobot_msgs::msg::CartesianTrajectoryPoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<addverb_cobot_msgs::msg::CartesianTrajectoryPoint>()
{
  return &addverb_cobot_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addverb_cobot_msgs, msg, CartesianTrajectoryPoint)() {
  return &addverb_cobot_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectoryPoint__handle;
}
