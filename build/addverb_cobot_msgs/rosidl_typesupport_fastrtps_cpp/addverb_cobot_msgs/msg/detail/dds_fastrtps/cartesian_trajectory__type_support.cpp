...
#include "addverb_cobot_msgs/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const addverb_cobot_msgs::msg::CartesianTrajectoryPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  addverb_cobot_msgs::msg::CartesianTrajectoryPoint &);
...
cdr_serialize(
  const addverb_cobot_msgs::msg::CartesianTrajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  addverb_cobot_msgs::msg::CartesianTrajectory & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        addverb_cobot_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CartesianTrajectoryPoint(
  ...
  if (is_plain) {
    ...
    using DataType = addverb_cobot_msgs::msg::CartesianTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const addverb_cobot_msgs::msg::CartesianTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<addverb_cobot_msgs::msg::CartesianTrajectory *>(
    untyped_ros_message);
...
{
  return &addverb_cobot_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addverb_cobot_msgs, msg, CartesianTrajectory)() {
  return &addverb_cobot_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectory__handle;
}
